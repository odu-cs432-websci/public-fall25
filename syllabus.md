# CS 432/532, Fall 2025 Syllabus

[Jump to Summary Schedule](#summary-schedule) | [Download printable PDF version](https://github.com/odu-cs432-websci/public-fall25/raw/main/syllabus.pdf)
...
**Prerequisites:** A grade of C or better in any one of: CS 250, CS 251, CS 253, CS 260, CS 261, CS 263, or DASC 255

## Instructor Contact and Office Hours

Nasreen Arif: nasreen at cs.odu.edu, <https://www.cs.odu.edu/~narif>

Office hours will be held Monday through Thursday by appointment only. Please use the provided link to schedule your [appointment](https://outlook.office.com/book/Fall2025OfficeHours@olddominion.onmicrosoft.com/?ismsaljsauthenabled). All scheduled meetings will take place via Zoom. Once your appointment is confirmed, you will receive a Zoom link in the confirmation email
...
* CRN 22336 - WEB2 (in Hampton Roads)
* CRN 22338 - WEB5 (in Virginia, but outside of Hampton Roads)
* CRN 22339 - WEB7 (in the US, but outside of Virginia)

CS 532 (graduate) sections:

* CRN 22340 - WEB2 (in Hampton Roads or in Virginia)
* CRN 22341 - WEB5 (in Virginia, but outside of Hampton Roads)
* CRN 22342 - WEB7 (in the US, but outside of Virginia)

## Requirements

### Prerequisites

Prerequisites: Standing as an undergraduate senior, graduate student, or approval from the instructor. Undergraduates should have a grade of C or better in any one of: CS 250, CS 251, CS 253, CS 260, CS 261, CS 263, or DASC 255
...
[ODU Fall 2025 academic schedule](https://www.odu.edu/academics/calendar/fall)
...
|5|Sept 20|Introduction to Info Vis with R, Python
|6|Sept 27|Archiving the Web
|7|Oct 4|Social Networks
| |Oct 11|**October 11-14 NO CLASS - Fall Break**
|8|Oct 18|Selection and Social Influence
|9|Oct 25|Visualizing Social Networks
|10|Nov 1|Collective Intelligence and Recommender Systems
|11|Nov 8|Clustering Algorithms|
|12|Nov 15|Document Filtering (Classification)
|13|Nov 22|Disinformation and LLMs
|14|Dec 1|kNN and Algorithm Summary
|| Friday, Dec 5|*last day of classes*
